...
from tasks.models import Annotation, AnnotationDraft, Comment, FailedPrediction, Prediction, Task, TaskLock
...
class CommentFactory(factory.django.DjangoModelFactory):
    task = factory.SubFactory(TaskFactory)
    project = factory.SelfAttribute('task.project')
    annotation = factory.SubFactory(AnnotationFactory, task=factory.SelfAttribute('..task'), project=factory.SelfAttribute('..project'))
    created_by = factory.SubFactory(load_func(settings.USER_FACTORY))
